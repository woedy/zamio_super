...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["publisher", "status"], name="publishers__publish_57e4de_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="publisherartistrelationship",
            index=models.Index(
                fields=["artist", "status"], name="publishers__artist__c42b7f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="publisherartistrelationship",
            index=models.Index(
                fields=["status", "start_date"], name="publishers__status_a7ae57_idx"
            ),
        ),
