...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="royaltyratestructure",
            index=models.Index(
        ...
        migrations.AddIndex(
            model_name="royaltyratestructure",
            index=models.Index(
                fields=["is_active", "territory"], name="royalties_r_is_acti_090847_idx"
            ),
        ),
        ...
        migrations.AddField(
            model_name="royaltycalculationaudit",
            name="calculated_by",
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.AddField(
            model_name="reciprocalagreement",
            name="partner",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddField(
            model_name="partnerreportexport",
            name="partner",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddIndex(
            model_name="usageattribution",
            index=models.Index(
                fields=["territory", "played_at"], name="royalties_u_territo_aab024_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="royaltywithdrawal",
            index=models.Index(
                fields=["requester", "status"], name="royalties_r_request_65d2c2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="royaltywithdrawal",
            index=models.Index(
                fields=["artist", "status"], name="royalties_r_artist__e205ec_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="royaltywithdrawal",
            index=models.Index(
                fields=["publisher", "status"], name="royalties_r_publish_7d8fd3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="royaltywithdrawal",
            index=models.Index(
                fields=["status", "requested_at"], name="royalties_r_status_8aadd9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="royaltycalculationaudit",
