...
import { Search, Bell, Settings, User, HelpCircle, MessageSquare, Upload, Clock, CreditCard, MapPin, Building2, Users, Shield, Activity, DollarSign, TrendingUp, LayoutDashboard } from "lucide-react";
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const navigationItems = [
    ...
    { name: "Royalty Management", icon: <DollarSign className="w-5 h-5" /> , route: "/royalty-management"},
    { name: "Financial Oversight", icon: <TrendingUp className="w-5 h-5" /> , route: "/financial-oversight"},
    { name: "Royalty & Payments Oversight", icon: <CreditCard className="w-5 h-5" /> , route: "/royalties"},
    { name: "International Partners", icon: <Building2 className="w-5 h-5" />, route: "/partners" },
    { name: "International Partners Ops", icon: <Building2 className="w-5 h-5" />, route: "/partner-ops" },
