...
const AllArtistsPage = () => {
  ...
  const [orderArtists, setOrderArtists] = useState('');
  ...
  }, [baseUrl, search, page, userToken, orderArtists]);
                ...
                <tbody className="bg-white/5 divide-y divide-white/10">
                  {artists.map((artist) => (
                    <tr key={artist.artist_id}>
                      <td className="px-4 py-2">{artist.artist_id}</td>
                      <td className="px-4 py-2 text-white">
                        {artist.stage_name}
                      </td>
                      <td className="px-4 py-2">{artist.total_earnings}</td>
