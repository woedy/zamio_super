...
const ReviewFlagConfirmationModal = ({ isOpen, onConfirm, onCancel, itemId, inputError, setComment, comment }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
      <div className="bg-white dark:bg-boxdark p-4 rounded-lg shadow-lg">
        <h2 className="text-lg font-semibold mb-4">Review Flag Playlog</h2>
        <p>
...
export default ReviewFlagConfirmationModal;
