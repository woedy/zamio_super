    ...
    <div className={cn('space-y-2', className)}>
      ...
      {loading && (
        <div className="flex justify-center">
          <div className="text-sm text-text-secondary">Verifying...</div>
        </div>
      )}
      
      {error && (
        <p id="code-error" className="text-sm text-error text-center" role="alert">
          {error}
        </p>
      )}
      
      {helperText && !error && (
        <p id="code-helper" className="text-sm text-text-secondary text-center">
          {helperText}
        </p>
      )}
    </div>
