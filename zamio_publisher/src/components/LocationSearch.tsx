    ...
    <div className={`relative ${className}`} ref={dropdownRef}>
      <div className="relative">
        ...
        <input
          ...
          className={`w-full pl-10 pr-10 py-4 bg-white/20 backdrop-blur-md border border-white/30 rounded-lg text-white placeholder-white focus:outline-none focus:ring-2 focus:ring-blue-400 ${
