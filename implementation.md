...
- **Task Checklist**
  ...
  - [x] Backend: Treat repeated uploads of the same KYC file for an existing document slot as idempotent replacements so resumed verification flows never surface duplicate-file validation errors.
